...
|-----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|
| **Bug fixes:**                                | Zero-Byte text-file creation hazard - Sometimes if OCR/Text-Extraction of the input document fails, a 0B .txt file may be left over which causes further retry attempts to believe the file has already been loaded         | :construction_worker: In-Progress         |
| **Practical Features:**                       | ***Ease-of-use centric:**                                                                                                                                                                                                   |                                           |
|                                               | Azure CV-OCR free-tier UI toggle                                                                                                                                                                                            | :white_check_mark: Done on 8th June 2024  |
|                                               | Delete Chats                                                                                                                                                                                                                | :construction_worker: In-Progress         |
|                                               | Rename Chats                                                                                                                                                                                                                | :calendar: Future Task                    |
|                                               | PowerShell Installation Script                                                                                                                                                                                              | :construction_worker: In-Progress         |
...
|                                               | Integration on OCR services from other cloud providers (GCP, AWS, OCI, etc.)                                                                                                                                                | :calendar: Future Task                    |
|                                               | **Performance-centric:**                                                                                                                                                                                                    |                                           |
...
|                                               | Local OCR with Vision LLMs: MS-TrOCR ([done](https://github.com/abgulati/LARS/blob/main/documents/refinements_research/Improving%20Text%20Extraction%20-%20Feb2024.pptx)), Llava, Chameleon (non-commercial, research only) | :calendar: Future Task                    |
